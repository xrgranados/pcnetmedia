...
var ENDSHOW_MESG="Fin de la presentación, haga clic para salir.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=9, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gMainDoc=new Array(new hrefList("slide0014.htm",1,-1,1),new hrefList("slide0024.htm",1,-1,1),new hrefList("slide0013.htm",1,-1,1),new hrefList("slide0007.htm",1,-1,1),new hrefList("slide0017.htm",1,-1,1),new hrefList("slide0023.htm",1,-1,1),new hrefList("slide0020.htm",1,-1,1),new hrefList("slide0021.htm",1,-1,1),new hrefList("slide0015.htm",1,-1,1));
...
var sNext="Siguiente",sPrev="Anterior",sEnd="Fin de la presentación",sFont="Arial",sArrow="Flecha",sFreeform="Forma libre",sRect="Rectángulo",sOval="Óvalo"
function ShowMenu()
{
	BuildMenu();
