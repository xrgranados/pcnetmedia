    ...
    <body>
        ...
        <div class="parentContainer" id="header">
            <section>
                ...
                <img src="assets/img/header/layer1.png" alt="Pcnet Media" id="layer1" />
                <img src="assets/img/header/layer2.png" alt="Pcnet Media" id="layer2" />
                <img src="assets/img/header/layer3.png" alt="Diseño" id="layer3" />
            </section>
        </div>
        ...
        <div class="parentContainer" id="services">
            <section>
               ...
               <ul class="portfolioMenu clearfix">
                    ...
                    <li class="all" data-filter=".webdesign">
                ...
                <ol class="portfolioContainer">
                    ...
                    <li class="project webdesign">
                        <a href="webdesing.html"><img class="mo" src="assets/img/portfolio/sampler.png" alt="">
                            <h3>Diseño Web</h3>
                        </a>
                    </li>
        ...
        <div class="parentContainer" id="portfolio">
            <section>
                <header class="clearfix">
                    ...
                    <h1>Proyectos</h1>
                    <h2>Conozca nuestros proyectos</h2><br><br>
                    <p></p>
                </header>
                <ol class="teamList clearfix">
                    <li>
                        ...
                        <ul class="socialIcons clearfix">
                            <li><a href="http://www.facebook.com/EQUUS.Guatemala" class="facebook" title="Facebook" target="_blank"></a></li>
                            <li><a href="https://twitter.com/equusgt" class="twitter" title="Twitter" target="_blank"></a></li>
                            <li><a href="http://pinterest.com/equusgt" class="pinterest" title="Pinterest" target="_blank"></a></li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="socialIcons clearfix">
                            <li><a href="http://www.facebook.com/enlacegt/app_208195102528120" class="facebook" target="_blank"></a></li>
                        </ul>
                    </li>
                    <li>
        ...
        <div class="parentContainer" id="timeline">
            <section>
                ...
                <a href="#" class="monthButton">Enero 2013</a>
                ...
                <a href="#" class="monthButton">Diciembre 2012</a>
                <div class="month clearfix">
                    <div class="leftColumn clearfix">
                        <div class="post-twitter post">
                            <img src="assets/img/timeline/alexolag.png" alt="">
