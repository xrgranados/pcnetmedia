            ...
            <section>
                ...
                <div class="info">
                    <p>
                        ...
                        <strong>C.C. Miraflores</strong><br>
                        Tel: 2474-8308 / 2474-2557<br> <br>

                        <strong>C.C. Pradera Concepción</strong><br>
                        Tel: 6637-1012 / 6637-1010<br>

                    </p> <br><br>

                    <img src="assets/images/contactimg.png" alt="">
                </div>
                <div class="contact">
                    <script type="text/javascript">var submitted=false;</script>
                    <iframe name="hidden_iframe" id="hidden_iframe"
                    style="display:none;" onload="if(submitted)
                    {window.location='http://www.pcnetmedia.com/equus/contactus.php';}"></iframe>
                    <form action="https://docs.google.com/a/pcnetmedia.com/spreadsheet/formResponse?formkey=dEY1N2VJekl2NENWZjZ0ZW1UWHJfeEE6MA&amp;ifq" method="post"
                    ...
                    <br> <div class="errorbox-good">
                    <div class="ss-item ss-item-required ss-select"><div class="ss-form-entry"><label class="ss-q-title" for="entry_9">&iquest;Como se enter&oacute; de EQUUS?:
                    <span class="ss-required-asterisk">*</span></label>
                    <select name="entry.9.single" id="entry_9"><option value="Internet">Internet</option> <option value="Revista">Revista</option> <option value="Television">Television</option> <option value="Shopping">Shopping</option> <option value="Recomentaci&oacute;n de Amigos">Recomentaci&oacute;n de Amigos</option> <option value="Otros">Otros</option></select></div></div></div>
                    <br> <div class="errorbox-good">
